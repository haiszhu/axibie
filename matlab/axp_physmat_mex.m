...
mex_id_ = 'axp_physmat_r64(c i int64_t[x], c i int64_t[x], c i int64_t[x], c i int64_t[x], c i int64_t[x], c i dcomplex[x], c i dcomplex[x], c i double[x], c i dcomplex[x], c i double[x], c i dcomplex[x], c i dcomplex[x], c i int64_t[x], c i int64_t[x], c i int64_t[x], c i double[x], c i double[x], c io double[x], c io double[x], c io dcomplex[x], c io double[x], c io double[x], c io dcomplex[x], c io double[x], c io double[x], c io dcomplex[x], c io double[x], c io double[x], c io dcomplex[x], c io double[x], c io double[x], c io double[x])';
[iAb, jAb, xAb, iAi, jAi, xAi, iF, jF, xF, iFi, jFi, xFi, iT, jT, xT] = AxiStokes3D_mex(mex_id_, iphys, ilayer, nc, p, np, sx, snx, sws, swxp, tpan, sxlo, sxhi, M, iside, iclosed, mu, R, iAb, jAb, xAb, iAi, jAi, xAi, iF, jF, xF, iFi, jFi, xFi, iT, jT, xT, 1, 1, 1, 1, 1, nsp, nsp, nsp, nsp, npp1, np, np, 1, 1, 1, 1, 9, Np1, nnzA, nnzA, Np1, nnzA, nnzA, Np1, nnzF, nnzF, Np1, nnzF, nnzF, Np1, nnzT, nnzT);
