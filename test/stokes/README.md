...
|---|---|
| ![convergence](imgs/axissymsstok_stok_slp_convergence.png) | ![3D error](imgs/axissymsstok_stok_slp_error.png) |
...
| h-refinement convergence | 3D target-grid error (`np=16`) |
|---|---|
| ![convergence](imgs/axissymsstok_stok_dlp_convergence.png) | ![3D error](imgs/axissymsstok_stok_dlp_error.png) |
...
| h-refinement convergence | 3D target-grid error (`np=16`) |
|---|---|
| ![convergence](imgs/axissymsstok_stok_slpn_convergence.png) | ![3D error](imgs/axissymsstok_stok_slpn_error.png) |
...
| h-refinement convergence | 3D target-grid error (`np=16`) |
|---|---|
| ![convergence](imgs/axissymsstok_stok_dlpn_convergence.png) | ![3D error](imgs/axissymsstok_stok_dlpn_error.png) |
...
|---|---|
| ![convergence](imgs/axissymsstok_stok_slp0th_convergence.png) | ![meridian error](imgs/axissymsstok_stok_slp0th_error.png) |
...
|---|---|
| ![convergence](imgs/axissymsstok_stok_dlp0th_convergence.png) | ![meridian error](imgs/axissymsstok_stok_dlp0th_error.png) |
...
| h-refinement convergence | meridian-grid error (`np=36`) |
|---|---|
| ![convergence](imgs/axissymsstok_stok_slpn0th_convergence.png) | ![meridian error](imgs/axissymsstok_stok_slpn0th_error.png) |
...
| h-refinement convergence | meridian-grid error (`np=36`) |
|---|---|
| ![convergence](imgs/axissymsstok_stok_dlpn0th_convergence.png) | ![meridian error](imgs/axissymsstok_stok_dlpn0th_error.png) |
